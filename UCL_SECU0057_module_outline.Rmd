...
- Tutorial
- Homework
    - [Rvest tutorial 1](https://www.datacamp.com/community/tutorials/r-web-scraping-rvest)
    - [Rvest tutorial 2](https://towardsdatascience.com/web-scraping-tutorial-in-r-5e71fd107f32)
    - [Rvest tutorial 3](https://towardsdatascience.com/learn-to-create-your-own-datasets-web-scraping-in-r-f934a31748a5)
